                ...
                child: FloatingActionButton(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextField(controller: taskNameController ,decoration: InputDecoration(hintText: "TASK NAME...", border: InputBorder.none, hintStyle: TextStyle(color: Colors.grey, fontSize: 20)),),
                                      ...
                                      child: Row(children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              border: Border.all(
                                                  width: 1, color: _selectedDate != null ? Colors.red : Colors.grey),
                                              borderRadius:
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: _deadline == null
                                                ? TextStyle(
                                                    color: const Color.fromARGB(255, 221, 140, 140))
                                                : const TextStyle(
                                                    color: Colors.red,
                                                    fontSize: 16),
                                          )
                                  ...
                                  const SizedBox(height: 10,),
                                  Text("Description".tr(), style: TextStyle(color: Colors.grey, fontSize: 18),),
                                  TextField(controller: descriptionController ,decoration: InputDecoration(hintText: "Add description for task",border: InputBorder.none, hintStyle: TextStyle(color: Colors.grey, fontSize: 14),))  ,
                                        ...
                                        onPressed: () async {
                                          ...
                                          if(taskName.isNotEmpty) {
                                            ...
                                            if(_selectedDate != null) {
                                              data.addAll({"deadline": _selectedDate.toString()});
                                            }
                                            String jsonBody = jsonEncode(data);
                                            final response = await http.post(createTaskUrl, headers: {"Content-Type": "application/json"}, body: jsonBody);
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('New task'.tr(), style: TextStyle(fontSize: 16, color: Colors.white),),
