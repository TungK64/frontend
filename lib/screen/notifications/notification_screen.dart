                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    state.items[index]['type'] ==
                                                            'created'
                                                        ? Text(
                                                            state.items[index]["message"].toString().substring(0, state.items[index]["message"].length - 9) +
                                                                " task " +
                                                                state.task[
                                                                    index] +
                                                                " in project " +
                                                            ...
                                                            style: TextStyle(
                                                                fontSize: 16,
                                                                fontWeight: ((state.items[index]['status'] == null || state.items[index]['status'] == false)
                                                                    ? FontWeight
                                                                        .bold
                                                                    : FontWeight
                                                                        .normal)))
                                                        : (state.items[index]['type'] == 'reject' || state.items[index]['type'] == 'accept') ||
                                                                state.items[index]['type'] ==
                                                                    "suggest topic"
                                                            ? Text(
                                                                state.items[
                                                                ...
                                                                style:
                                                                    TextStyle(
                                                                  fontSize: 16,
                                                                  fontWeight: ((state.items[index]['status'] ==
                                                                              null ||
